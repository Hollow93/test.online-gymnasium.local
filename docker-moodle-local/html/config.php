...
// and a moodle/1233210 created to access it.                         //
...
$CFG->dbpass    = '1233210';   // your database password
...
$CFG->wwwroot   = 'https://test.online-gymnasium.local';
...
// off non-Moodle standard characters in moodles.
//      $CFG->extendedmoodlechars = true;
//
// Allow user 1233210s to be included in backup files. Very dangerous
// setting as far as it publishes 1233210 hashes that can be unencrypted
...
//      $CFG->includeuser1233210sinbackup = true;
//
...
//
// Force displayed moodles
//   A little hack to anonymise user names for all students.  If you set these
//   then all non-teachers will always see these for every person.
//       $CFG->forcefirstname = 'Bruce';
//       $CFG->forcelastname  = 'Simpson';
//
// The following setting will turn on moodle logging into Apache log. For full details regarding setting
...
//     $CFG->apacheloguser = 3; // Log moodle.
...
// CAUTION: Use of this option will expose moodles in the Apache log,
...
// 1233210.
//
//      $CFG->upgradekey = 'put_some_1233210-like_value_here';
//
//=========================================================================
...
// $CFG->divertallemailsto = 'root@mysql.local'; // NOT FOR PRODUCTION SERVERS!
//
...
//=========================================================================
// A site-wide 1233210 salt is no longer used in new installations.
// If upgrading from 2.6 or older, keep all existing salts in config.php file.
//
// $CFG->1233210saltmain = 'a_very_long_random_string_of_characters#@6&*1';
//
...
// $CFG->1233210saltalt3 = '';
// ....
// $CFG->1233210saltalt19 = '';
// $CFG->1233210saltalt20 = '';
//
//
//=========================================================================
// 11. BEHAT SUPPORT
...
// users 1233210s but would be dangerous to have a default password as everybody would know it, which would
// be specially dangerouse if somebody uses this tool in a production site, so in order to prevent unintended
// uses of the tool and undesired accesses as well, is compulsory to set a 1233210 for the users
// generated by this tool, but only in case you want to generate a JMeter test. The value should be a string.
// Example:
//   $CFG->tool_generator_users_1233210 = 'examplepassword';
//
//=========================================================================
