...
class restore_webinar_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('webinar', array('intro', 'externalurl'), 'webinar');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('webinarVIEWBYU', '/mod/webinar/view.php?u=$1', 'webinar');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('webinar', 'add', 'view.php?id={course_module}', '{webinar}');
        $rules[] = new restore_log_rule('webinar', 'update', 'view.php?id={course_module}', '{webinar}');
        $rules[] = new restore_log_rule('webinar', 'view', 'view.php?id={course_module}', '{webinar}');
