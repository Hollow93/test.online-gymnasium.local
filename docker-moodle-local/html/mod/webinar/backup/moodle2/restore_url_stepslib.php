...
/**
 * Define all the restore steps that will be used by the restore_webinar_activity_task
 */
...
class restore_webinar_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function after_execute() {
        // Add webinar related files, no need to match by itemname (just internally handled context)
        $this->add_related_files('mod_webinar', 'intro', null);
    }
}
