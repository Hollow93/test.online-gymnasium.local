...
/**
 * Define all the backup steps that will be used by the backup_webinar_activity_task
 *
 * @package    mod_webinar
...
defined('MOODLE_INTERNAL') || die;
 ...
 /**
 * Define the complete webinar structure for backup, with file and id annotations
 */
class backup_webinar_activity_structure_step extends backup_activity_structure_step {

    protected function define_structure() {

        //the webinar module stores no user info
        ...
        $webinar->annotate_files('mod_webinar', 'intro', null); // This file area hasn't itemid
